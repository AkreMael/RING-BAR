...
export default function InteractiveMap({
  ...
  return (
    <div id="interactive-map-container" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <div className="lg:col-span-7 bg-neutral-950 border border-neutral-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-6 relative z-10">
          <div>
            <h3 className="text-lg font-bold text-white tracking-wide uppercase italic">Plan du Ring Bar</h3>
        ...
        {/* SVG Wrapper */}
        <div className="relative aspect-[4/3] w-full border border-neutral-800 rounded-2xl bg-black p-2 select-none">
          <svg
            viewBox="0 0 800 600"
          ...
          >
            ...
            <rect x="20" y="20" width="760" height="560" rx="20" fill="none" stroke="#262626" strokeWidth="4" />
            
            {/* ENTRÉE Zone */}
            <g transform="translate(40, 500)">
              <rect x="0" y="0" width="120" height="60" rx="8" fill="#0a0a0a" stroke="#262626" strokeDasharray="4 4" />
            ...
            <g transform="translate(620, 40)">
              <rect x="0" y="0" width="140" height="70" rx="8" fill="#171717" stroke="#dc2626" strokeWidth="1" />
              <text x="70" y="32" textAnchor="middle" fill="#dc2626" className="text-[10px] font-black tracking-widest font-mono italic">
                CABINE DJ
              </text>
              <path d="M 30,45 L 110,45" stroke="#404040" strokeWidth="2" strokeDasharray="2 2" />
              {/* Turntables */}
              <circle cx="45" cy="52" r="10" fill="#262626" stroke="#dc2626" />
              <circle cx="95" cy="52" r="10" fill="#262626" stroke="#dc2626" />
            </g>

            {/* COMPTOIR (The main bar counter) */}
            <g transform="translate(30, 40)">
              <rect x="0" y="0" width="220" height="70" rx="8" fill="#171717" stroke="#262626" strokeWidth="1.5" />
              <text x="110" y="32" textAnchor="middle" fill="#e5e5e5" className="text-[10px] font-black tracking-widest font-mono">
                LE COMPTOIR (BAR)
              </text>
            ...
            <g transform="translate(320, 240)">
              <rect x="0" y="0" width="240" height="180" rx="12" fill="#0a0a0a" stroke="#262626" strokeWidth="2" strokeDasharray="3 3" />
              <circle cx="120" cy="90" r="40" fill="none" stroke="#262626" strokeWidth="1" strokeOpacity="0.5" />
              <text x="120" y="95" textAnchor="middle" fill="#a3a3a3" className="text-[10px] font-black tracking-widest font-mono">
                PISTE DE DANSE
              </text>
            </g>
            ...
            <g transform="translate(770, 180)">
              ...
              <text x="-90" y="18" transform="rotate(-90)" fill="#a3a3a3" className="text-[10px] font-black tracking-widest font-mono">
                GRAND MIROIR
              </text>
            </g>
            ...
            {SALONS.map((salon) => {
              ...
              let fillColor = selected
                ? 'rgba(220, 38, 38, 0.25)' // selected red glow
                : reserved
                ? 'rgba(239, 68, 68, 0.05)' // reserved dim red
                : 'rgba(23, 23, 23, 0.8)'; // normal dark

              if (reserved) strokeColor = '#7f1d1d';
              ...
              return (
                ...
                >
                  ...
                  <text
                    ...
                    y={y + 35}
                    textAnchor="middle"
                    fill={selected ? '#ffffff' : reserved ? '#fca5a5' : '#e5e5e5'}
                  ...
                  <text
                    ...
                    y={y + 55}
                    textAnchor="middle"
                    fill={selected ? '#f87171' : reserved ? '#ef4444' : '#a3a3a3'}
                  ...
                  <text
                    ...
                    y={y + 75}
                    textAnchor="middle"
                    fill={reserved ? '#f87171' : selected ? '#ffffff' : '#737373'}
      ...
      <div className="lg:col-span-5 space-y-4">
        <h4 className="text-white font-bold text-xs uppercase tracking-widest px-1 flex items-center gap-2">
            ...
            return (
              <button
                ...
                className={`w-full text-left p-5 rounded-2xl border transition-all duration-300 relative overflow-hidden flex flex-col ${
                  reserved
                    ...
                    : selected
                    ? 'bg-neutral-900 border-red-600 shadow-[0_0_20px_rgba(220,38,38,0.15)]'
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: reserved ? '#7f1d1d' : selected ? '#dc2626' : '#262626' }}
                />

                <div className="flex justify-between items-start pl-2">
                  <div>
                    <span className="text-[10px] font-mono font-bold tracking-widest uppercase block" style={{ color: reserved ? '#ef4444' : selected ? '#f87171' : '#a3a3a3' }}>
                      {salon.id === 4 ? '★ SALON EXCLUSIF VIP ★' : `EMPLACEMENT N°${salon.id}`}
                    </span>
                    <h5 className="text-base font-black text-white mt-1 uppercase italic">
                ...
                <p className="text-xs text-neutral-400 mt-3 pl-2 leading-relaxed">
                  {salon.description}
                </p>

                <div className="flex flex-wrap gap-4 mt-4 pl-2 text-xs text-neutral-400 font-medium">
                ...
                <div className="mt-4 pt-3 border-t border-neutral-800 pl-2 flex justify-between items-center text-xs font-semibold">
                  <span className="text-neutral-500 uppercase tracking-wider text-[10px]">Consommation minimum :</span>
                  <span className="text-white font-mono">{salon.priceMin} €</span>
                </div>
              </button>
            );
          })}
